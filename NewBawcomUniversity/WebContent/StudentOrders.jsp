...
<%  ArrayList li=new ArrayList();
    Statement st2=com.bawcom.db.DB.getConnect().createStatement();
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
          <li class="active"><a href="StudentOrders.jsp">Student Orders [<%=li.size()%>]</a></li>
...
<div class="mySlider">
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="panel-heading">Student Orders</div>
...
table#t01 tr td a {
    color: white;
                                    ...
                                    <table id="t01" style="width: 100%;">
                                        ...
                                            <th style="text-align: center">Student Ordered Items</th>
